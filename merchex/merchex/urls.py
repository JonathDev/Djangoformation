...
urlpatterns = [
    ...
    path('listing/add/', views.create_listing, name='listing-create'),
    path('listing/<int:id>/change/', views.listing_update, name='listing_update'),
    path('lisitng/<int:id>/delete/', views.listing_delete, name= 'listing_delete'),
    path('email-sent/', views.email_sent, name='email_sent'),  # Ajoutez ce chemin
]
